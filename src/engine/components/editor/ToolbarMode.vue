    ...
    <div>
        <v-tooltip bottom>
            <v-btn color="primary darken-2" slot="activator" icon @click="onChangeModeDialog">
                <v-icon dark>fa-th-large</v-icon>
            </v-btn>
            <span>Programlama Modu</span>
        </v-tooltip>
        <v-dialog v-model="modeDialog" max-width="800px" persistent>
            <v-card>
                <v-card-title>
                    <span class="headline">Programlama Modu Seçiniz</span>
                </v-card-title>
                <v-divider></v-divider>
                <v-card-text>
                    <v-item-group>
  ...
  export default {
    ...
    data() {
      return {
        ...
        modes: [
          {
            name: "Bloklar ile programlama",
            desc: "Bloklarla kolayca programlayın",
            icon: {
          ...
          {
            name: "Bloklar ve Kod ile programlama (Blok & Kod)",
            desc: "Bloklar ile programlarken C++ kod karşılığını görün",
            icon: {
          ...
          {
            name: "Yazarak programlama",
            desc: "C++ dilini kullanarak programlayın",
            icon: {
