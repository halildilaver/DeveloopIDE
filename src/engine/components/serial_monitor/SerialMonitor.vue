    ...
    <v-card flat class="serial-console">
                ...
                <v-flex style="display: flex; flex-direction: column; height: 100%; width: 100%">
                    <div class="d-flex" style="flex-grow: 0">
                        <v-combobox
                                ...
                                v-model="currentPort"
                                :items="comports"
                                label="İletişim kanalı (COM PORT) seç"
                        ></v-combobox>
                        <v-combobox
                                dense
                                v-model="baudrate"
                    ...
                    <v-layout col style="display: flex; flex: 0 1 auto; flex-grow: 1; overflow: hidden;">
                        <v-flex v-if="showMode === 'text'" xs12 class="ml-2">
                            <v-switch style="height: 25px; margin-top: 0px;"
                                      v-model="auto_scroll"
                                      :label="`Otomatik Kayma : ${auto_scroll}`">
                            </v-switch>
                            <v-switch style="height: 25px;"
                                      v-model="display_raw"
                                      :label="`Hex String göster: ${display_raw}`">
                            </v-switch>
                        </v-flex>
                        <v-flex xs12 v-else>
                            <v-flex class="pa-2">
                    ...
                    <v-layout col style="display: flex; flex: 0 1 auto;">
                        <v-flex xs12>
                            <v-btn :color="isOpened?'error':'primary'" @click="connect">
                                {{isOpened?"Bağlantıyı Kes" : "Bağlan"}}
                            </v-btn>
                            ...
                            <v-menu top :offset-y="true">
                                ...
                                <v-card>
                                    <v-container fluid grid-list>
                                        <v-layout col wrap>
                                            <v-flex xs12>
                                                <div class="title">İletişim Kontrolü</div>
                                            </v-flex>
                                        </v-layout>
                                        <v-layout col wrap>
                                            <v-flex xs4>
                                                <v-subheader class="pl-0">Veri Biti</v-subheader>
                                            ...
                                            <v-flex xs6>
                                                <v-subheader class="pl-0">Benzerlik biti</v-subheader>
                                        ...
                                        <v-layout col wrap>
                                            <v-flex xs4>
                                                <v-subheader class="pl-0">Durdurma biti</v-subheader>
                                            ...
                                            <v-flex xs6>
                                                <v-subheader class="pl-0">Akış Kontrolü</v-subheader>
                        ...
                        <v-menu top :offset-y="true">
                            ...
                            <v-card>
                                <v-container fluid grid-list>
                                    <v-layout col wrap>
                                        <v-flex xs12>
                                            <v-subheader class="pl-0">Gönder : {{send_time}} time{{send_time>1?"s":""}}
                                            </v-subheader>
                                            <v-slider v-model="send_time" min="1" max="100" thumb-label></v-slider>
                                        </v-flex>

                                        <v-flex xs12>
                                            <v-subheader class="pl-0">Gecikme : {{send_delay}} ms</v-subheader>
        ...
        <div v-if="showMode==='graph'" class="auto-scroll-switch">
            <v-tooltip top>
                ...
                <span>Grafiği resim olarak kaydet</span>
            </v-tooltip>
        </div>
        <v-speed-dial
                v-model="fab"
