  ...
  >
    ...
    <v-tooltip bottom>
      <template v-slot:activator="{ on }">
        <img v-on="on" src="/static/logo/logo.png" height="45"
             alt="Problem? report me at fb.com/halildlvr"
             class="mr-3"
             style="border-radius: 8px; background-color: #ffffffa8; //margin-top: 4px;">
      </template>
      <span>DeveloopIDE by Kivvi</span>
    </v-tooltip>
    <v-tooltip bottom>
      <template v-slot:activator="{ on }">
        <img v-on="on" src="/static/logo/kivvioes.png" height="45"
             alt="Kivvi OES"
             class="mr-2"
             style="border-radius: 8px; background-color: rgba(255, 255, 255, 0.8); //margin-top: 4px;">
      </template>
      <span>Kivvi Online Eğitim Sistemi</span>
    </v-tooltip>
